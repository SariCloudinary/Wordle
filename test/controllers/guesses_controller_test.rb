...
class GuessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guess" do
    assert_difference("Guess.count") do
      post guesses_url, params: { guess: { game_session_id: @guess.game_session_id, guessed_word: @guess.guessed_word, user_id: @guess.user_id } }
    end
  ...
  test "should update guess" do
    patch guess_url(@guess), params: { guess: { game_session_id: @guess.game_session_id, guessed_word: @guess.guessed_word, user_id: @guess.user_id } }
