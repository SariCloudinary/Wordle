...
class GameSessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_session" do
    assert_difference("GameSession.count") do
      post game_sessions_url, params: { game_session: { done: @game_session.done, score: @game_session.score, word: @game_session.word } }
    end
  ...
  test "should update game_session" do
    patch game_session_url(@game_session), params: { game_session: { done: @game_session.done, score: @game_session.score, word: @game_session.word } }
